...
description = 'A virtual assistant inspired on T-800 from Terminator'
try:
...
setup(
    ...
    author_email='hms.sud@gmail.com',
    ...
    entry_points={
        'console_scripts': [
            't800 = t800.__main__:main',
        ],
    },
    zip_safe=False,
    keywords="virtual assistant speech-to-text text-to-speech t800 jarvis",
)
